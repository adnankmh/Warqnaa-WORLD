...
cd /d "%~dp0\..\..\.."
title Warqnaa V0.4.4+200 - Port 8008
set "WARQNA_PORT=8008"
...
start "Warqnaa Laravel 8008" cmd /k php artisan serve --host=127.0.0.1 --port=8008
popd
timeout /t 2 /nobreak >nul
start "" http://127.0.0.1:8008
echo Laravel: http://127.0.0.1:8008
echo Flutter API: http://127.0.0.1:8008/api/mobile/v1
echo To run Flutter Web use: flutter_app\RUN_FLUTTER_WEB.bat 8008
pause
