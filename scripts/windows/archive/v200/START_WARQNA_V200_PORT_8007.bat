...
cd /d "%~dp0\..\..\.."
title Warqnaa V0.4.4+200 - Port 8007
set "WARQNA_PORT=8007"
set "APP_URL=http://127.0.0.1:8007"
set "FRONTEND_URL=http://127.0.0.1:8007"
...
start "Warqnaa Laravel 8007" cmd /k php artisan serve --host=127.0.0.1 --port=8007
popd
timeout /t 2 /nobreak >nul
start "" http://127.0.0.1:8007
echo Laravel: http://127.0.0.1:8007
echo Flutter API: http://127.0.0.1:8007/api/mobile/v1
echo To run Flutter Web use: flutter_app\RUN_FLUTTER_WEB.bat 8007
pause
